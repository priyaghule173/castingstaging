  ...
  <div class="col-lg-8">
   <div class="data_card">
     ...
     <ul class="nav nav-tabs">
      <?php
      $Pending = $this->db->select('count(job_id) as total')->from('job_posts')->where('job_status','0')->get()->result_array();
      ?>
      <li class="active"><a data-toggle="tab" href="#tab1">Pending Job Request&nbsp;(<?php echo $Pending[0]['total']?>)</a></li>
      
      <li><a data-toggle="tab" href="#tab2">Active/ Approved Job Request</a></li>
      
      <li><a data-toggle="tab" href="#tab3">Rejected Job Request</a>
      </li>
    </ul>
            ...
            <tbody style="font-size: 12px;">
              ...
              foreach ($result as $row) {
                ...
                <tr>
                  ...
                  <td>
                    <select name="job_action" onchange="showUser(this.value,<?php echo $row['job_id']?>)">
        ...
        <div class="box-body table-responsive no-padding">
          <table id="example4" class="table table-hover">
           ...
           foreach ($result1 as $row) {
            ...
            <td>
              <?php echo $row['job_post_expired_date']; ?>
            </td>
    ...
    <table id="example4" class="table table-hover">
      ...
      foreach ($result2 as $row) {
        ...
        <tr>
          ...
          <td>
            <?php echo $row['job_post_approved_date']; ?>
          </td>
          <td>
            <select name="job_action" onchange="showUser(this.value,<?php echo $row['job_id']?>)">
              <option disabled="disabled" selected="selected">Select Action</option>
...
function showUser(str,JID)
{
  var JID_new = JID;
  var job_action = str;
  $.ajax({
    type: "POST",
    url: "<?php echo base_url('admin/update_job_post_status')?>",
    data: {'job_id': JID_new ,'job_status' :job_action},
    success: function () {
      alert("Status Updated Successfully!..");
      window.location.href = "<?php echo base_url('admin/job_post_request')?>";     
    }
  });
}
</script>
