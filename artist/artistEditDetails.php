              ...
              ?>
							<div class="col-sm-4">
                                     <div class="picture-container">
                                          <div class="picture">
                                              <img src="<?php echo base_url()?>assets/images/profile_pic/<?php echo $key['profile_pic'];?>" class="picture-src" id="wizardPicturePreview" title=""/>
                                  ...
                                  <div class="col-sm-4">
                                      <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $key['name'];?>" id="name" name="name">
                                      </div>
                                      <div class="form-group">
                                          <label>Email <small>(required)</small></label>
                                        <input type="email"  class="form-control" value="<?php echo $key['email_id'];?>" id="email" name="email">
                                      </div>
                                      <div class="form-group">
                                        <label>Mobile No. <small>(required)</small></label>
                                        <input type="text" class="form-control" value="<?php echo $key['contact_no'];?>" id="mobile" name="mobile">
                                      </div>
                                      <div class="form-group">
                                        <label>Date of Birth: <small>(required)</small></label>
                                        <input name="dob" id="dob" type="date" value="<?php echo $key['date_of_birth'];?>" class="form-control" >
                                      </div>
                                  </div>
                                  <div class="col-sm-4">
                                      <div class="form-group">
                                        <label>Select City <small>(required)</small></label>
                                          <input id="city" type="text" value="<?php echo $key['city'];?>" class="form-control" placeholder="Enter City"name="city">
                                      ...
                                      <div class="form-group">
                                          <label>Zipcode </label>
                                          <input id="zipcode" type="text" value="<?php echo $key['pin_code'];?>" class="form-control" placeholder="Enter Zipcode"name="zipcode">
                                      </div>
                                      <div class="form-group">
                                        <label>Whatsapp No. </label>
                                        <input id="whatsapp" type="text" class="form-control" placeholder="Enter Whatsapp No." value="<?php echo $key['whatsup_no'];?>" name="whatsapp">
                                      </div>
                                      <div class="form-group">
                                        <label>Gender: </label><br>
                                        <label class="radio-inline">
                                        <input type="radio" name="gender" id="gender"  <?php if($key['gender']=="male"){
                                        echo "checked";
                                      }?> value="male">Male
                                        </label>
                                        <label class="radio-inline">
                                        <input type="radio"  name="gender" id="gender" <?php if($key['gender']=="female"){
                                        echo "checked";
                                      }?> value="female">Female
                                        </label>
                                        <label class="radio-inline">
                                        <input type="radio" name="gender" id="gender"  <?php if($key['gender']=="transgender"){
                                        echo "checked";
                                  ...
                                  <div class="col-md-4 col-md-offset-4">
                                    <label class="checkbox-inline">
                                      <input type="checkbox" name="terms" <?php if($key['terms_condition']=="1"){
                                        echo "checked";
 ...
 $("#btnArtistDetails").click(function(){
      ...
      if(validation_status == true ) {
        ...
        form_data.append('profile_pic', $('input[type=file]')[0].files[0]);
                form_data.append("btnArtistDetails", $('#btnArtistDetails').val());    
              ...
              //  form_data.append("wizardPicturePreview", $('#wizardPicturePreview').val());    
                ...
                $.ajax({
                  url: '<?php echo base_url('artist/editdetails/'); ?>',
                  type: 'POST',              
                  data : form_data,
                  processData: false,
                  contentType: false,
              ...
              .done(function (res) {
                ...
                if(res.status="success"){
                  ...
                  window.location.href="<?php echo base_url('artist/artistEditTalent')?>";
                }
