       ...
       <input type="hidden" name="sub_talent" >
        ...
        $sub_talent_name = $this->db->select('*')->from('sub_talent')->where('talent_id',$key['talent_id'])->get()->result_array();
         ...
         foreach ($sub_talent_name as $key ) {  ?>
          ...
          <?php $TA = explode(',',$value['sub_talent']);
                              foreach($TA as $val){?>
          <input type="checkbox" <?php if($val==$key['sub_talent_id']){
                                        echo "checked";
                                      }?> name="sub_talent_name[]" id="sub_talent_name" value="<?php echo $key['sub_talent_id'];?>" id="sub_talent_name">
                                       <?php } ?>
    ...
    $("#btnArtistSubTalentRegister").click(function(){
      ...
      if(validation_status == true ) {
        ...
        var form_data = new FormData();   
                ...
                form_data.append("btnArtistSubTalentRegister", $('#btnArtistSubTalentRegister').val());
