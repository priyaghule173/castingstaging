                                  ...
                                  <div class="col-md-12">
									 ...
									 //   $talent=explode(',', talent_name);
                                		...
                                		<label class="chkcontainer">
                  						...
                  						<?php $TA = explode(',',$value['talent']);
                  						foreach($TA as $val){?>
                  						<input type="checkbox" <?php if($val==$key['talent_id']){
                                        echo "checked";
                                      }?> name="talent_name[]" value="<?php echo $key['talent_id'];?>" id="talent_name">
                                  <?php } ?>
...
$("#btnArtistTalentRegister").click(function(){
      ...
      if(validation_status == true ) {
        ...
        var form_data = new FormData();   
                ...
                form_data.append("btnArtistTalentRegister", $('#btnArtistTalentRegister').val());
                ...
                $.ajax({
                  ...
                  url: '<?php echo base_url('artist/edittalent/'); ?>',
                  type: 'POST',              
                  data : form_data,
                  processData: false,
                  contentType: false,
              ...
              .done(function (res) {
                ...
                if(res.status="success"){
                  ...
                  window.location.href="<?php echo base_url('artist/artistEditSubTalent')?>";
                }
