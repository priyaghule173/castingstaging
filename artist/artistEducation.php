				...
				<form class="form-inline" action="" method="post">
					...
					<div class="video-box col-md-12">
						...
						<div class="pull-right col-md-12">
	                        <a href="javascript:void(0);" class="add_video_btn" title="Add field"> <i class="fa fa-plus" aria-hidden="true"></i>&emsp;<label style="font-size: 20px;color:#AD8C29;cursor: pointer;">Add More Education</label></a>
	                    </div>
                    ...
                    <div class="row  pull-right"><br>
						<button type="submit" name="submit" class="btn btn-default btn-block" id="btnArtistEducationRegister">Next</button>
					</div>
					</div>
				</form>	
			</div>
	...
	<script type="text/javascript">
        ...
        $(addVideoBtn).click(function () {
            if (video_x < maxField) {
				...
				fieldHTML += '<label>School/College/Company *</label>';
				fieldHTML += '<input type="text" name="" class="form-control">';
				fieldHTML += '</div>';
				fieldHTML += '</div>';
				fieldHTML += '<div class="col-md-5">';
				fieldHTML += '<div class="form-group">';
				fieldHTML += '<label>Course Completed * *</label>';
				fieldHTML += '<input type="text" name="" class="form-control">';
				fieldHTML += '</div>';
				fieldHTML += '</div>';
				...
				fieldHTML += '<div class="form-group">';
				fieldHTML += '<label>Year of completion *</label>';
				fieldHTML += '<input type="text" name="" class="form-control">';
				fieldHTML += '</div>';
				fieldHTML += '</div>';
				fieldHTML += '<div class="col-md-4">';
				fieldHTML += '<div class="form-group">';
				fieldHTML += '<label>City * </label>';
				fieldHTML += '<input type="text" name="" class="form-control">';
				fieldHTML += '</div>';
				fieldHTML += '</div>';
				fieldHTML += '<div class="col-md-4">';
				fieldHTML += '<div class="form-group">';
				fieldHTML += '<label>Country *</label>';
				fieldHTML += '<input type="text" name="" class="form-control">';
				fieldHTML += '</div>';
				fieldHTML += '</div>';
				fieldHTML += '</div>';
