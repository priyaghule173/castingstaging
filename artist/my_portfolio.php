...
<div class="container">
        ...
        <br>
          <div class="input-group">
            ...
            <ul class="list-inline">
            <li>
              <label class="radiocontainer">Yes, Previous Experience is Mandatory
              <input type="radio" checked="checked" name="isExperienceRequired" id="isExperienceRequired">
              <span class="radiocheckmark"></span>
            </label>
            </li>
           <li>
           <label class="radiocontainer">No, Previous Experience is not Mandatory
            <input type="radio" name="isExperienceRequired" id="isExperienceRequired">
            <span class="radiocheckmark"></span>
          </label>
              </li>
          </ul>                                           
      ...
      <ul class="list-inline">
       <li>
         <label class="radiocontainer">Yes, Audition is Mandatory
        <input type="radio" checked="checked" id="isAuditionRequired" name="isAuditionRequired">
        <span class="radiocheckmark"></span>
      </label>
      </li>
        <li>
     <label class="radiocontainer">No, Audition is not Mandatory
        <input type="radio" id="isAuditionRequired" name="isAuditionRequired">
        <span class="radiocheckmark"></span>
      </label>
      </li>
    </ul>                               
