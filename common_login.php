                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                <div class="register-links">
                                    <h4 style="color: green;padding-bottom: 15px;">Not Registered yet,</h4>

                                   <a href="<?php echo base_url('Welcome/director_registration'); ?>"><p>  <i class="fa fa-user" aria-hidden="true"></i>  Register  Director </p></a>
                                   <a href="<?php echo base_url('Welcome/signupArtist'); ?>"> <p>  <i class="fa fa-user" aria-hidden="true"></i>  Register  Artist  </p></a>
...
<!--Director Login -->
            <div class="tabs-content">
                            ...
                            <div id="login-tab-content" class="active">
                                 ...
                                 <?php 
                              if($this->session->flashdata('regMessage')){ ?>

                              <div class="col-lg-12">
                              <div class="alert alert-success alert-dismissible" id="success-alert" style="background-color: green;color: #fff;padding: 7px 13px 0px 19px;">
                             <!-- <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a> -->
                             <strong > <?php echo $this->session->flashdata('regMessage');  ?></strong> 
                            </div>
                          </div>
