    ...
    <div class="sidebar" data-color="purple" data-background-color="white" data-image="assets/adminimages/sidebar-1.jpg" style="margin: -0.1Rem 1px;">
      <div class="logo" style="padding: 15px 0px 10px 0;">
...
<li class="nav-item " id="">
            <a class="nav-link dropdown-toggle" href="#application_sub" data-toggle="collapse" aria-expanded="false">
          ...
          <li class="nav-item ">
            <a class="nav-link dropdown-toggle" href="#homeSubmenu" data-toggle="collapse" aria-expanded="false">
             ...
             <ul class="collapse list-unstyled" id="homeSubmenu">
                    ...
                    <li class="padleft30 getpreviledge" id="getpreviledge" style="padding-bottom: 15px;">
...
"></i>
                                     ...
                                     <!--  </div> -->
                                       ...
                                       <!--  <div class="form-group social-link-input"> -->
                                         <a href="<?php $imdb_url;?>"target="_blank">
...
$(".processapp").click(function(e)
{
  // alert(1);
    ...
    $.ajax({
        ...
        url:'<?php echo base_url('dashboard/recieveapplication')?>',
        success:function(response){
