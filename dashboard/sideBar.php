...
"></i>
      ...
      <li class="nav-item AppliedJobs" id="AppliedJobs">
            <a class="nav-link"  href="#">
          ...
          <li class="nav-item JobApplication" id="JobApplication">
            <!-- <a class="nav-link" href="<?php //echo base_url('dashboard/approvedApplications'); ?>"> -->
            <a class="nav-link" href="#">
              ...
              <p>Relavant Jobs</p>
                  ...
                  <li class="nav-item commingSoon" id="commingSoon">
            <!-- <a class="nav-link" href="<?php //echo base_url('dashboard/myTokens'); ?>"> -->
            ...
            <a class="nav-link dropdown-toggle" href="#homeSubmenu" data-toggle="collapse" aria-expanded="false">
             ...
             <ul class="collapse list-unstyled" id="homeSubmenu">
                    <li class="padleft30 artistsettings" id="artistsettings" style="padding-bottom: 15px;">
                      <i class="material-icons" style="width: 0px;">view_list</i>
 ...
 $ARTIST_ID = $this->session->userdata('EMAIL_ID');
    ...
    if($ARTIST_ID !='')
    {
    $data = $this->db->select('*')->from('artists')->where('a_id',$this->session->userdata('ARTIST_ID'))->get()->result_array();
    ...
    $(".postJob").removeClass("active");
           $(".postedJobs").removeClass("active"); 
            ...
            $(".approvedApplicationList").removeClass("active");
             $(".mysettings").removeClass("active"); 
              $(".getpreviledge").removeClass("active"); 
                $(".JobApplication").removeClass("active");
...
$(".AppliedJobs").click(function(e)
{
  // alert(1);
   $("#Applied_JobsForm").show();
    e.preventDefault();
    $.ajax({

        url:'<?php echo base_url('dashboard/AppliedJobs')?>',
        success:function(response){
           
           $("#Applied_JobsForm").html(response);
              $(".AppliedJobs").addClass("active");
...
$(".JobApplication").click(function(e)
{
  // alert(1);
