...
">
          ...
          <img src="<?php echo base_url()?>assets/images/profile_pic/<?php echo $value['profile_pic']; ?>" class="picture-src" id="blah" title="" alt="" style="width: 16%;height: 150px;/*margin: 21 auto;*/border-radius: 100%;"/>

                                                    <!-- <img id="blah" /> -->
                                                  <?php }else { ?>
                                                      
          <img src="<?php echo base_url()?>assets/images/profile_pic/userprofile.jpg" class="picture-src" id="wizardPicturePreview" title="" alt="" style="width: 16%;height: 150px;margin: 21 auto;border-radius: 100%;" style="
    border-bottom: 1px solid lightgray;
    padding-bottom: 22px;
" />
                                                  <?php } ?>
...
// alert(999);
    ...
    ">
                          ...
                          <?php }?>
                            <form id="prject1">
                            <div class="video-box1 col-md-12" style="
    padding-bottom: 10px;
">
    ...
    ">
                    <div class="col-lg-12 hideIconwork<?php echo $key['work_id']?>" style="
    padding-bottom: 10px;
">
     ...
     ">delete_forever</i>
                        ...
                        <i class="fa fa-pencil" onclick="newWork(<?php echo $key['work_id']?>, <?php echo htmlspecialchars(json_encode($resultWork)) ?>)"
                         style="
          float: right;
         /* font-size: 18px;
    padding-top: 20px;
    ...
    "></i>
      ...
      <div class="col-md-6 labelproject">
...
<span>:</span>
    ...
    color: red;
    font-size: 14px;
" id="project_type_error<?php echo $key['work_id']?>"></div>
          </div>
        </div>
...
" for="staticEmail" >Production Name</label>
    ...
    color: red;
    font-size: 14px;
" id="production_name_error<?php echo $key['work_id']?>"></div>
          </div>
        </div>
         <div class="form-group">
          <label style="
...
" for="staticEmail" >Link If Any</label>
          ...
          " value="<?php echo $key['link'];?>"  class="form-control" value="" >
                    ...
                    <div class="col-md-6 labelproject" style="
    /* padding-bottom: 10px; */
    margin-bottom: 10px;
">
...
">Project Title</label>
    ...
    color: red;
    font-size: 14px;
" id="project_title_error<?php echo $key['work_id']?>"></div>
          </div>
        </div>
...
<span>:</span>
    ...
    color: red;
    font-size: 14px;
" id="year_error<?php echo $key['work_id']?>"></div>
          </div>
        </div>
        <div class="form-group">
          <label for="staticEmail"  style="
...
" id="year_error1"></div>
          ...
          // $('.submit').click(function(){
             ...
             // var additional_info=$("#additional_info").val();
              if(project_type.trim() == '') { 
                      $("#project_type_error1").show();            
                      $("#project_type_error1").html("<strong> * Please Enter project type.<strong>");
                      status = false;
                    }
                     else if(production_name.trim() == '') { 
                      $("#production_name_error1").show();            
                      $("#production_name_error1").html("<strong> * Please Enter Production name.<strong>");
                      status = false;
                    } 
                    //  else if(link.trim() == '') { 
                    //   $("#error-boxwork").show();            
                    ...
                    // }  
                      ...
                      $("#project_title_error1").show();            
                      $("#project_title_error1").html("<strong> * Please Enter Project Title.<strong>");
                    
                      status = false;
                    }  
                    else if(year.trim() == '') { 
                      $("#year_error1").show();            
                      $("#year_error1").html("<strong> * Please Enter Year.<strong>");
                      status = false;
                    }    
        ...
        var $additional_info_new=document.getElementById("additional_info" +$data).value;
          ...
          //alert('hii');
           ...
           // alert(validation_status_project);
            ...
            {
            $("#project_type_error"+$data).hide();
                 $("#project_title_error"+$data).hide();
                  $("#production_name_error"+$data).hide();  
                   $("#year_error"+$data).hide();
 ...
 $("#error-boxwork").show();  
                    if(project_type.trim() == '') { 
                      $("#project_type_error"+$data).show();            
                      $("#project_type_error"+$data).html("<strong > * Please Enter Project Type.<strong>");
                      status = false;
                    }            
                    else if(project_title.trim() == '') { 
                      $("#project_title_error"+$data).show();            
                      $("#project_title_error"+$data).html("<strong> * Please Enter Project Title.<strong>");
                      status = false;
                    }     
                    else if(production_name.trim() == '') { 
                      $("#production_name_error"+$data).show();            
                      $("#production_name_error"+$data).html("<strong> * Please Enter Production Number.<strong>");
                      status = false;
                    } 
                    
                    else if(year.trim() == '') { 
                      $("#year_error"+$data).show();            
                      $("#year_error"+$data).html("<strong> * Please Enter Year.<strong>");
                      status = false;
                    } 
  ...
  var socialdiv12 = document.getElementById('social_parent_div');
   ...
   for(var i=0;i<resultData.length;i++)
    ...
    ">
     ...
     <?php }?>
                            <form id="award" >
                             <div class="video-box col-md-12" style="
    padding-bottom: 10px;
">
                            <?php
    ...
    cursor: pointer;
          ">delete_forever</i>
                        ...
                        <i class="fa fa-pencil" data-toggle="modal" onclick="newAward(<?php echo $val['award_id']?>, <?php echo htmlspecialchars(json_encode($resultAward)) ?>)"style="
                      /*  font-size: 18px;
    padding-top: 20px;
    margin-left: 10px;*/
          float: right;
...
<span>:</span>
    ...
    color: red;
    font-size: 14px;
" id="award_title_error<?php echo $val['award_id']?>"></div>
          </div>
      </div>
...
<span>:</span>
    ...
    color: red;
    font-size: 14px;
" id="award_year_error<?php echo $val['award_id']?>"></div>
          </div> 
      </div>     
...
<span>:</span>
    ...
    color: red;
    font-size: 14px;
" id="award_for_error<?php echo $val['award_id']?>"></div>
          </div>
      </div>
      <div class="form-group row">
          <label for="staticEmail" style="
      ...
      function AddAwardReg()
        {
          var status = true; 
           var award_title=$("#award_title").val();
              ...
              if(award_title.trim() == '') { 
                      $("#award_title_error1111").show();            
                      $("#award_title_error1111").html("<strong> * Please Enter Company Name.<strong>");
                      status = false;
                    }
                     else if(award_year.trim() == '') { 
                      $("#award_year_error_add").show();            
                      $("#award_year_error_add").html("<strong> * Please Enter Award Year.<strong>");
                      status = false;
                    } 
                     else if(award_for.trim() == '') { 
                      $("#award_for_error_add").show();            
                      $("#award_for_error_add").html("<strong> * Please Enter Award For.<strong>");
                      status = false;
                    }  
    ...
    $.ajax({
      ...
      var $add_details_new=document.getElementById("add_details" +$data).value;
          ...
          console.log("Inside award function........................");
            ...
            if(validation_status_awards == true ) {
                $("#award_title_error"+$data).hide();
               $("#award_for_error"+$data).hide(); 
                $("#award_year_error"+$data).hide(); 
              var form_data = new FormData();  
            // alert("hiii");
            //pretty-print('hiii'); 
              //form_data.append("directorId", $('#directorId').val());
      ...
      var $add_details_new=document.getElementById("add_details" +$data).value;         
            ...
            var add_details=$add_details_new;
                    ...
                    if(award_title.trim() == '') { 
                      $("#award_title_error"+$data).show();            
                      $("#award_title_error"+$data).html("<strong> * Please Enter Award Title.<strong>");
                      status = false;
                    }            
                    else if(award_for.trim() == '') { 
                      $("#award_for_error"+$data).show();            
                      $("#award_for_error"+$data).html("<strong> * Please Enter Award For.<strong>");
                      status = false;
                    }     
                    else if(award_year.trim() == '') { 
                      $("#award_year_error"+$data).show();            
                      $("#award_year_error"+$data).html("<strong> * Please Enter Award Year.<strong>");
                      status = false;
                    } 
 ...
 // $("a").attr("href", "javascript: void(0);" ); 
    ...
    cursor: pointer;
          ">delete_forever</i>
                        ...
                        <i class="fa fa-pencil" data-toggle="modal" onclick="newAssoc(<?php echo $valu['assoc_id']?>, <?php echo htmlspecialchars(json_encode($result)) ?>)" style="
...
" for="staticEmail">Association Name</label>
    ...
    color: red;
    font-size: 14px;
" id="association_name_error<?php echo $valu['assoc_id']?>"></div>
          </div>
      </div>
...
<span>:</span>
    ...
    color: red;
    font-size: 14px;
" id="association_id_error<?php echo $valu['assoc_id']?>"></div>
          </div>
      </div>
    ...
    color: red;
    font-size: 14px;
" id="association_name_error_add"></div>
                                            </div>
    ...
    color: red;
    font-size: 14px;
" id="association_id_error_add"></div>
                                              <!-- &nbsp;&nbsp;&nbsp;&nbsp; -->
  ...
  console.log("resultDataAssoc", resultDataAssoc);
   ...
   $(".view-association-section").show();
    ...
    if(association_name.trim() == '') { 
                      $("#association_name_error_add").show();            
                      $("#association_name_error_add").html("<strong> * Please Enter association Name.<strong>");
                      status = false;
                    }
                    else if(association_id == '') { 
                      $("#association_id_error_add").show();            
                      $("#association_id_error_add").html("<strong> * Please Enter Association Id.<strong>");
                      status = false;
                    }
    ...
    $.ajax({
     ...
     // alert($association_id_new);
      ...
      console.log("Inside assoc function........................");
         ...
         $("#association_name_error"+$data).hide(); 
                $("#association_id_error"+$data).hide(); 
              var form_data = new FormData();     
                  //al
    ...
    document.getElementById('hidecloseasoc'+$data).style.display = "none";
      ...
      var association_name= $association_name_new;
            var association_id=$association_id_new;
                    ...
                    if(association_name.trim() == '') { 
                       $("#association_name_error"+$data).show();            
                      
                        $("#association_name_error"+$data).html("<strong> * Please Enter Association Name.<strong>");
                    
                     status = false;
                     
                    }            
                    else if(association_id == '') { 
                      $("#association_id_error"+$data).show();            
                      $("#association_id_error"+$data).html("<strong> * Please Enter Association Id.<strong>");
                      status = false;
                    }     
                    console.log("validation_status....................",status);
                    return status;
