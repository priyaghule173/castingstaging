            ...
            <div class="tab-pane fade show active hideprofile" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                  ...
                  <div class="col-lg-12">
                   ...
                   <div class="col-lg-6 hideIcon">
                    ...
                    <i class="fa fa-edit" data-toggle="modal" onclick="newInfo()" style="font-size: 34px;
      padding-top: 19px;
      margin-left: 382px;"></i>
                   </div>
                 </div>
  ...
  <span class="btn btn-default btn-file addscript" style="    background-color: #ff007c;">
  ...
  Browse… <input type="file" runat="server" name="profile_pic"  id="profile_pic" class="form-control">
                                 ...
                                 <div class="row">
                                   <div class="col-lg-6">
                                        <div class="form-group required" >
                                          ...
                                          <input type="text" readonly class="form-control-plaintext" id="companyName"  style="border-radius: 5px;
      padding: 5px;" value="<?php echo $value['official_name'];?>" name="companyName" >
        ...
        padding: 5px; background-color: white;" readonly name="email" id="email" class="form-control-plaintext" value="<?php echo $value['email_id'];?>" placeholder="Enter Official Email Id">
                                        ...
                                        <div class="form-group required">
                                          ...
                                          <input type="phone" readonly name="mobile" id="mobile" style="border-radius: 5px;
      ...
      padding: 5px;" readonly name="city" id="city" class="form-control-plaintext" value="<?php echo $value['city'];?>" placeholder="Enter City Name">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" readonly name="pincode" id="pincode" style="border-radius: 5px;
      padding: 5px;" class="form-control-plaintext" value="<?php echo $value['pin_code'];?>" placeholder="Enter Pin Code">
                                        </div>
                                        <div class="form-group">
                                          <label>Official Address </label>
                                          <input class="form-control-plaintext" readonly name="address" style="border-radius: 5px;
      padding: 5px; background-color: white;" id="address" rows="5" value="<?php echo $value['address'];?>" id="comment" placeholder="Enter office Adress">
                                     ...
                                     <?php } ?>
                                      ...
                                      <button type="button" name ="submit" value="submit" readonly class="btn btn-default  pull-right" id="btnDirectorProfile" style="    background-color: #ff007c;">Save</button>
                                      <button type="button" class="btn btn-default  pull-right" style="    background-color: #ff007c;" id="closeprofile" onclick="goBackprofile()">Cancel</button>
...
function goBackprofile() {
          ...
          <form class="form-inline" action="" method="post">
            <div class="col-md-12 text-center">
             ...
             <!--  <h2>Education: Add educational Qualifications(if any)</h2><hr> -->
              ...
              <div class="add-more-block row" id="project_parent_div<?php echo $key['work_id']?>">
   ...
   <div class="form-group row required">
    ...
    <div class="form-group row required">
     ...
     <div class="form-group row required">
      ...
      <div class="col-md-7">
        <input type="text" readonly class="form-control-plaintext" name="link" id="link<?php echo $key['work_id']?>" style="border-radius: 5px;
  ...
  <div class="form-group row required">
    ...
    <div class="form-group row required">
      ...
      padding: 20px;
      ">
                               <button type="button" id="saveBtn<?php echo $key['work_id']?>"  name="submit" style="width: 110px;/* margin-left: 743px; */float: right;display: block;background-color: rgb(255, 0, 124);" onclick="GetProject(<?php echo $key['work_id']?>)"
...
function goBackworkexp($data) {
  ...
  <!-- *************** -->
            ...
            <div class="add-more-block row">
                <div class="col-md-6">
                  <div class="form-group required">
                                          ...
                                          <input type="text" readonly class="form-control" style="border-radius: 5px;
                ...
                <div class="col-md-6">
                  <div class="form-group required">
                                          <label> Project Title</label>&nbsp;&nbsp;&nbsp;
                                            <input type="text" readonly name="project_title1" style="border-radius: 5px;
      ...
      padding: 5px;" id="project_type" name="project_type" >
                  ...
                  <div class="form-group required">
                                            <label>Production Name</label>&nbsp;&nbsp;&nbsp;
                                          <input type="text" name="production_name" style="border-radius: 5px;
      padding: 5px;"  id="production_name" class="form-control">
                                        </div>
                
                  <div class="form-group">
                                          <label>Link If Any <small></small></label>&nbsp;&nbsp;&nbsp;
                                          <input type="text"name="link" id="link" style="border-radius: 5px;
      ...
      padding: 20px;
      ">
                               <button type="button" onclick="AddWorkExp()" name="submit" style="width: 110px;
  ...
  function GetDetails(project_type)
  {
    // var project_type_new=document.getElementById("project_type<?php echo $key['work_id']?>").value;
    // var project_title_new=document.getElementById("project_title<?php echo $key['work_id']?>").value;
    // var production_name_new=document.getElementById("production_name<?php echo $key['work_id']?>").value;
    // var year_new=document.getElementById("year<?php echo $key['work_id']?>").value;
    // var link_new=document.getElementById("link<?php echo $key['work_id']?>").value;
    // var additional_info_new=document.getElementById("additional_info<?php echo $key['work_id']?>").value;
    //alert(id);
  ...
  var $year_new=document.getElementById("year" +$data).value;
    ...
    var $additional_info_new=document.getElementById("additional_info" +$data).value;
      ...
      //alert('hii');
        var validation_status = directorFormValidateProject($data);
          ...
          <form class="form-inline" action="" method="post">
            ...
            <div class="col-md-12 text-center">
             ...
             <!--  <h2>Education: Add educational Qualifications(if any)</h2><hr> -->
              ...
              <div class="add-more-block row" id="award_parent_div<?php echo $val['award_id']?>">
      ...
      <div class="col-md-7">
        <input type="text" readonly class="form-control-plaintext" readonly name="add_details" id="add_details<?php echo $val['award_id']?>" value="<?php echo $val['add_details'];?>">
               ...
               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center hideSaveAward" id="hideSaveAward<?php echo $val['award_id']?>" style="padding: 20px;">
                               <button type="button"  name="submit" id="saveBtnAward<?php echo $val['award_id']?>" style="width: 110px;/* margin-left: 743px; */float: right;display: block;background-color: rgb(255, 0, 124); onclick="GetAward(<?php echo $val['award_id']?>)"
     class="btn btn-default btn-block" >Save</button>
...
function goBackaward($data) {
  ...
  <!-- <button type="submit" name="submit" style="width: 110px;background-color: #ff007c;
      float: right;" class="btn btn-default btn-block" id="btnDirectorAward">Save</button> -->
             ...
             <!--   <?php if($value['award_title1']!='' ||$value['award_year1']!='' ||$value['award_for1']!='' || $value['add_details1']!=''){ ?>
                ...
                <div class="col-md-6">
                                        ...
                                        <input type="text" readonly class="form-control" id="award_title1"  style="border-radius: 5px;
      ...
      padding: 5px;" class="form-control" id="award_title"  value=""  name="award_title">
                                         ...
                                         <div class="form-group required">
                                          <label>Award Year <small></small></label>&nbsp;&nbsp;&nbsp;
                                          <input type="text" name="award_year" id="award_year" style="border-radius: 5px;
      padding: 5px;" class="form-control" value="" >
                                        </div>
  ...
  var $add_details_new=document.getElementById("add_details" +$data).value;
      ...
      console.log("Inside award function........................");
        var validation_status = directorFormValidateAwards($data);
        console.log(validation_status);
        if(validation_status == true ) {
          $("#error-box").hide(); 
          var form_data = new FormData();  
...
document.getElementById('hidecloseaward'+id).style.display = "block";
  ...
  <!-- Social Link Section  -->
               ...
               <div id="awards" style="background-color: #fff;">
                  <form class="" method="post" id="formId" action="" enctype="multipart/form-data" style="padding: 10px;">
                    ...
                    <div class="row" id="">
                        <!-- ************** -->
                       <div class="col-lg-12">
                                 <div class="row social_parent_div" id="social_parent_diffv">
                                   <div class="col-lg-6">
                                       
                                      <div class="form-group">
                                         <span class="wrapper facebook">

                                         <input type="text" class="social-link-input-class" value="<?php echo $value['facebook_url'];?>"  id="facebook" style="border-radius: 5px;
      padding: 5px;" readonly name="facebook"   placeholder="facebook"/>
                                         ...
                                         <input type="text" style="border-radius: 5px;
      padding: 5px;" readonly class="social-link-input-class" value="<?php echo $value['instagram_url'];?>"  id="instagram"  name="instagram"   placeholder="Instagram"/>
                                       </span>
                                        </div>
                                         ...
                                         <input type="text" style="border-radius: 5px;
      padding: 5px;" readonly class="social-link-input-class" value="<?php echo $value['website_url'];?>"  id="website"  name="website"   placeholder="Website Link"/>
                                       </span>
                                        </div>
                                    ...
                                    <!-- *********** -->
                                     <div class="col-lg-6">
                                         ...
                                         <input type="text" class="social-link-input-class" style="border-radius: 5px;
      ...
      padding: 5px;" readonly value="<?php echo $value['youtube_url'];?>"  id="youtube"  name="youtube"   placeholder="YouTube"/>
                                         ...
                                         <input type="text" readonly class="social-link-input-class" style="border-radius: 5px;
      padding: 5px;" value="<?php echo $value['imdb_url'];?>" id="imdb"  name="imdb"   placeholder="IMDB"/>
                                      ...
                                      <button type="button" name ="submit" value="submit" class="btn btn-default  pull-right" style="background-color: #ff007c;"id="btnDirSocialLinks">Save</button>
<button type="button" class="btn btn-default  pull-right id="closesocial" style="background-color: #ff007c;" onclick="goBacksocial()">Cancel</button>
        ...
        function newSocial()
        {
             ...
             $(".hideIconsocial").hide();
              $(".closesocial").show();
               ...
               // $(".social_parent_div").addClass("show-border");
               $(".social_parent_div").each(function() {
    $(this).addClass("show-border");
});

             var socialDiv = document.getElementByClass('social_parent_div');
 ...
 document.getElementById('closesocial').readOnly = false;
  ...
  <div class="video-box col-md-12">
   <?php
    ...
    <div class="add-more-block row" id="assoc_parent_div<?php echo $valu['assoc_id']?>" style="margin-bottom: 20px;">
  ...
  <div class="form-group row required">
      ...
      padding: 20px;
      ">
      <button type="button"  name="submit" id="saveBtnAssoc<?php echo $valu['assoc_id']?>" style="width: 110px;margin-left: 9px;float: right;display: none; background-color: #ff007c;" onclick="GetAssoc(<?php echo $valu['assoc_id']?>)"
      class="btn btn-default btn-block" >Save</button>
...
$(".hidecloseasoc"+$data).hide();
    ...
    //                 $(".hideIconwork"+$data).show();
      ...
      margin-bottom: 20px;">
                ...
                <div class="col-md-6">
                                        ...
                                        <label>Association Name</label>&nbsp;&nbsp;&nbsp;
                                          <input type="text" class="form-control" readonly id="association_name1" name="association_name1" style="border-radius: 5px;
      padding: 5px;" value="<?php echo $value['association_name1'];?>" >
                 ...
                 <div class="col-md-6">
                                        <div class="form-group required">
                                          ...
                                          <input type="text" readonly name="association_id1" style="border-radius: 5px;
     ...
     <!--  <style="background-color: #ddd;></style> -->
                <div class="col-md-6">
                                        <div class="form-group required">
                                        <label>Association Name</label>&nbsp;&nbsp;&nbsp;
                                          <input type="text" class="form-control" id="association_name" name="association_name" style="border-radius: 5px;
      padding: 5px;"  value="" >
                                        </div>
                 ...
                 <div class="col-md-6">
                                        <div class="form-group required">
                                          <label>Association ID</label>&nbsp;&nbsp;&nbsp;
                                          <input type="text" name="association_id" style="border-radius: 5px;
  ...
  console.log("Inside assoc function........................");
        ...
        var validation_status = directorFormValidate($data);
        console.log(validation_status);
        if(validation_status == true ) {
          $("#error-box").hide(); 
          var form_data = new FormData();     
...
document.getElementById('hidecloseasoc'+$data).style.display = "none";
   ...
   $(".hidecloseasoc"+$data).hide();
        ...
        function directorFormValidate($data)
            {   
              //var id=$data;
              //alert();
