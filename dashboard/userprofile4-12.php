...
">
          ...
          <img src="<?php echo base_url()?>assets/images/profile_pic/<?php echo $value['profile_pic']; ?>" class="picture-src" id="blah" title="" alt="" style="width: 18%;height: 150px;/*margin: 21 auto;*/border-radius: 100%;"/>

                                                    <!-- <img id="blah" /> -->
                                                  <?php }else { ?>
                                                      
          <img src="<?php echo base_url()?>assets/images/profile_pic/userprofile.jpg" class="picture-src" id="wizardPicturePreview" title="" alt="" style="width: 18%;height: 150px;margin: 21 auto;border-radius: 100%;" style="
    border-bottom: 1px solid lightgray;
    padding-bottom: 22px;
" />
                                                  <?php } ?>
...
<span>:</span>
          <div >
            <input type="text" readonly class="form-control-plaintext project_type<?php echo $countresu;?> " style=" font-size: 14px; 
    /*margin-left: 4px;*/
     font-size: 14px !important; 
     padding-top: 0px; " id="project_type<?php echo $key['work_id']?>" value="<?php echo $key['project_type'];?>" name="project_type" required >
            <div style="
    color: red;
    font-size: 14px;
...
" for="staticEmail" >Production Name</label>
          <span>:</span>
          <div>
            <input type="text" readonly class="form-control-plaintext production_name<?php echo $countresu;?> " value="<?php echo $key['production_name'];?>"  id="production_name<?php echo $key['work_id']?>" style=" font-size: 14px; 
    /*margin-left: 4px;*/
     font-size: 14px !important; 
     padding-top: 0px;" name="production_name" >
             <div id="production_name_error<?php echo $key['work_id']?>"></div>
          </div>
        </div>
         <div class="form-group">
          <label style="
...
" for="staticEmail" >Link If Any</label>
          <span>:</span>
          <div >
            <input type="text"  readonly class="form-control-plaintext link<?php echo $countresu;?>" name="link" id="link<?php echo $key['work_id']?>" style=" font-size: 14px; 
    /*margin-left: 4px;*/
     font-size: 14px !important; 
     padding-top: 0px; 
...
">Project Title</label>
          <span>:</span>
          <div>
            <input type="text" readonly class="form-control-plaintext project_title<?php echo $countresu;?>"style=" font-size: 14px; 
    /*margin-left: 4px;*/
     font-size: 14px !important; 
     padding-top: 0px;"  name="project_title" value="<?php echo $key['project_title'];?>"  id="project_title<?php echo $key['work_id']?>"  class="form-control" >
          </div>
        </div>
...
<span>:</span>
          <div >
            <input type="Number" readonly class="form-control-plaintext year<?php echo $countresu;?>" name="year" style=" font-size: 14px; 
    /*margin-left: 4px;*/
     font-size: 14px !important; 
     padding-top: 0px; " value="<?php echo $key['year'];?>"  id="year<?php echo $key['work_id']?>" class="form-control" value="" >
          </div>
        </div>
        <div class="form-group">
          <label for="staticEmail"  style="
...
">Additional Details</label>
    ...
    /*margin-left: 4px;*/
     font-size: 14px !important; 
     padding-top: 0px !important; " class="form-control-plaintext additional_info<?php echo $countresu;?>" readonly name="additional_info" id="additional_info<?php echo $key['work_id']?>" value="<?php echo $key['additional_info'];?>" class="form-control" >
          </div>
        </div>
                    </div>
