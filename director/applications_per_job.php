                                    ...
                                    <table class="table">
                                      <thead>
                                        <tr>
                                          ...
                                          <th scope="col">Artists Applications</th>
                                      ...
                                      <tbody>
                                        ...
                                        <td><a href="<?php echo base_url('director/view_job_applications?job_id=').$key['job_id'] ?>"><?php echo $count[0]['total'];?></td>

                                          <td>
                                            <a href="<?=base_url('director/job_details?job_id=').$key['job_id'] ?>" title="View"><i class="icon-eye"></i></a>&nbsp;&nbsp;
                                            <a href="<?=base_url('director/delete_job_post?job_id=').$key['job_id'] ?>" title="delete"><i class="icon-trash"></i></a>
                                         </td>
                                        </tr>
                                      <?php } ?>
                                      </tbody>
