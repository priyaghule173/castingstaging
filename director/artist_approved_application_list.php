           ...
           <div class="row">
             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 artistdashboard_leftsction">
              ...
              <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 artistdashboard_rightsction">
                <h1>My Dashboard</h1>
                    <h4>Artists Applications Approved List</h4>
                      <?php 
                                    ...
                                    <table class="table">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td><?php 
                                          // print_r($silver_pack);
                                            if(!empty($silver_pack)){ ?>

                                                  <form method="post" action="<?php echo base_url('director/active_casting_points')?>">
                                                  <input type="hidden" name="artist_id" value="<?php echo $key['a_id'];?>">
                                                  <input type="submit" class="btn btn-primary btn-xs" name="silver_pack" value="View Profile">
                                                  </form>
                                                 <?php 
                                              } else { ?>
                                                 <input type="submit" class="btn btn-primary btn-xs" name="buy_silver_pack" value="Buy Pack Now" data-toggle="modal" data-target="#myModal_1">
                                              <?php 
                                                } ?>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Choose the right plan for your project</p>
          <p>To customize your plan please email us at</p>
        </div>
