                         ...
                         <div class="row">
                             <div class="media">
                               <div class="media-left">
                                 <img height="100" width="120" src="<?php echo base_url()?>assets/images/work_1.png"> 
                                 </div>
                                 ...
                                 <h4 class="highlightgreen-text pull-right"> Applications Received : 22 Applications</h4>
                                 </div>
                             </div>
                           <?php ?>
                          </div>  
