...
<div class="container">
                     ...
                     <div class="row">
                       <div class="col-lg-8 col-lg-offset-2">
                        <form>
                          ...
                          <input type="text" readonly class="form-control" value="<?php echo $value['job_title']; ?>" id="title" placeholder="Enter Title of the Job Post">
                        </div>
                                                    
                       <div class="form-group">

                        <select class="form-control" id="artistCategory">
                       <option value="none">Select The Type of Artist Category</option>
                       <?php  $talent = $this->db->select('*')->from('talent')->get()->result_array();
                       foreach ($talent as $key) {
                       ?>
                          <option value="<?php echo $key['talent_name']?>" <?php if($value['artist_category']== $key['talent_name']){
                            echo "selected";
                          }?>><?php echo $key['talent_name'];?></option>
                          <?php } ?>
                        </select>
                      </div>
                      <div class="form-group">
									<textarea class="form-control" rows="5" id="jobDescription" placeholder="Enter Job Description" value="<?php echo $value['job_desc']; ?>"><?php echo $value['job_desc']; ?></textarea>
								</div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                    <input type="text" class="form-control" value="<?php echo $value['age_from']; ?>" id="ageFrom" placeholder="Age Group from">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-user" aria-hidden="true"></i></span>
                      <input type="text" class="form-control" id="ageUpto" value="<?php echo $value['age_upto']; ?>" placeholder="Age Group upto">
                    </div>
                  </div>
                  </div>
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-language" aria-hidden="true"></i></span>
                    <input type="text" class="form-control" value="<?php echo $value['languages']; ?>" id="languages" placeholder="Languages Known">
                  </div>
                  <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-map-marker" aria-hidden="true"></i></span>
                    <input type="text" class="form-control" value="<?php echo $value['location']; ?>" id="location" placeholder="Location">
                  </div>
                    <div class="row">
                  <div class="col-md-6">
                    <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                    <?php $date = $value['job_post_date']; ?>
                    <input type="input" readonly class="form-control" value="<?php echo date("Y-m-d",strtotime($date))?>" id="date" placeholder="Job Post Date">
                  </div> 
                  </div>
                  <div class="col-md-6">
                    <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-calendar" aria-hidden="true"></i></span>
                    <?php $date_exp = $value['job_post_expired_date']; ?>
                    <input type="input" readonly class="form-control" value="<?php echo date("Y-m-d",strtotime($date_exp))?>" id="Expired_date" placeholder="Job Expired Date">
                  </div>
                  </div>
                  </div>        
          ...
          <ul class="list-inline">
           <li>
              <label class="chkcontainer">
                   Male
                  <input type="checkbox"  name="gender[]" <?php if($value['gender']=="male"){ echo "checked"; }  ?> value="male"  id="gender">
              ...
              <label class="chkcontainer">
                   Female
                  <input type="checkbox" <?php if($value['gender']=="female"){ echo "checked"; }  ?> name="gender[]" value="female"  id="gender">
                  <span class="checkmark"></span>
              ...
              <label class="chkcontainer">
                   Other
                  <input type="checkbox" name="gender[]" <?php if($value['gender']== "neutral"){ echo "checked"; }  ?> value="neutral" id="gender">
                  <span class="checkmark"></span>
        ...
        <br>
          <div class="input-group">
            ...
            <li>
              ...
              <input type="radio" value="1" <?php if($value['previous_experi']== "1"){ echo "checked"; }  ?> checked="checked" name="isExperienceRequired"  id="isExperienceRequired">
              <span class="radiocheckmark"></span>
            </label>
            </li>
           <li>
           <label class="radiocontainer">No
            <input type="radio" value="0" <?php if($value['previous_experi']== "0"){ echo "checked"; }  ?> name="isExperienceRequired" id="isExperienceRequired">
            <span class="radiocheckmark"></span>
          </label>
              </li>
          </ul>                                           
      ...
      <ul class="list-inline">
       <li>
         <label class="radiocontainer">Yes
        <input type="radio" value="1" <?php if($value['audition_req']== "1"){ echo "checked"; }  ?> checked="checked" name="isAuditionRequired" id="isAuditionRequired">
        <span class="radiocheckmark"></span>
      </label>
      </li>
        <li>
     <label class="radiocontainer">No
        <input type="radio" value="0" <?php if($value['audition_req']== "0"){ echo "checked"; }  ?> name="isAuditionRequired" id="isAuditionRequired">
        <span class="radiocheckmark"></span>
      </label>
      </li>
    </ul>                               
        ...
        <div class="col-md-12">
          ...
          <input type="hidden" id="job_id" value="<?php  echo $value['job_id'];?>">
    ...
    $("#btnDirJobPost").click(function(){
      ...
      if(validation_status == true ) {
        ...
        var form_data = new FormData();   
                ...
                $.ajax({
                  url: '<?php echo base_url('director/edit_job_post1/'); ?>',
                  type: 'POST',              
                  data : form_data,
                  processData: false,
                  contentType: false,
              ...
              .done(function (res) {
                if(res.status="success"){
                  ...
                  window.location.href="<?php echo base_url('director/all_posting_jobs')?>";
                }
