             ...
             <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="artist_form pad40 " >
                                 ...
                                 <h3 class="text-left" style="text-align: left;"> Register As :</h3>                             
     <select class="input" style="background-color: rgba(81, 84, 90, 0.9);" name="director_type" id="director_type"> 

    <option value="1">Director</option>
    <option value="2">Assistant Director</option>
    <option value="3">Casting Director</option>
    <option value="4">Producer</option>
    <option value="5">Executive Producer</option>
    <option value="6">Others</option>
  </select>
               

                        <input type="taxt" class="input" name="companyName" id="companyName" autocomplete="off" placeholder="Company Name" required>
                        <input type="text" class="input" name="contact_no" id="contact_no" autocomplete="off" placeholder="Contact Number" required>
                        <input type="email" class="input"  name="dir_email" id="dir_email" autocomplete="off" placeholder="Official Email ID" required>

                        <input type="text" class="input" name="city" id="city" autocomplete="off" placeholder="City Name" required>
                        <input type="text" class="input" name="pin_code" id="pin_code" autocomplete="off" placeholder="Pin Code" required>
                        <input type="text" class="input" name="off_add" id="off_add" autocomplete="off" placeholder="Official Address" required> 
 
                        <input type="password" class="input" name="pass3" id="pass3" autocomplete="off" placeholder="Password" required>
                        <input type="password" class="input"name="pass4"  id="pass4" autocomplete="off" placeholder="Confirm Password" required>
                             <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                           <div class="row">
                             <div class="col-lg-6">
                                  <h4 style="color: #fff;padding: 6px;">Upload Profile Photo</h4>
                                  <label class="btn btn-primary browse-btn">
                                  Browse&hellip; <input type="file" name="profile_pic" accept="image/*" style="display: none;">
                                   </label>
                              </div>
                           <span id="profile-file-name" style="color:red;"></span>
                           <div class="col-lg-6">
                                  <h4 style="color: #fff;padding: 6px;">Upload Script</h4>
                                  <label class="btn btn-primary browse-btn">
                                  Browse&hellip; <input type="file" name="script_file" id="script_file" accept=".pdf,.doc" style="display: none;">
                                   </label>
                                   
                              </div>
                              <span id="script-file-name" style="color:red;"></span>
                      </div>
                         </div>
<!-- 
                     <label style="color: #fff;">Upload Profile Photo</label> 
                     <div class="row">
                      ...
                      <!-- <label style="color: #fff;">Upload Script</label>  -->
                       <!-- <input type="file" name="script_name" accept="image/*" style="float: right;"> -->
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" style="margin: 0 auto;    text-align: center;">
                                                <div id="error-box"></div>
                                           <button type="submit" id="btnDirectorRegister" class="btn btn-default rounded-btn" >Register</button>
                                        </div>
                                    </div>
...
//# sourceURL=pen.js
                ...
                $("#profile-file-name").text(this.files[0].name);
           });

                              $("#script_file").change(function(){
                $("#script-file-name").text(this.files[0].name);
           });
