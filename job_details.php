                    ...
                    <br>
                     <div class="row">
                      <div class="col-lg-6">
                         ...
                         <a class="btn pink-btn" readonly style="cursor: context-menu;">Apply for this Job</a>
                         </div>
                     </div>
                 </div>
           ...
           <div class="row">
               <div class="col-lg-12">
                 ...
                 <h3 class="mediumheader3"> <strong>Other Information</strong></h3>
                   ...
                   <p class="paragraph_text"> <?php echo $value['age_from']."  Years to ".$value['age_upto']." Years";?></p>
