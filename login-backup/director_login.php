...
<html>
	...
	<title>Casting Role | Director Login</title>
		...
		<div class="container">
            <div class="row">
				...
				<div class="registerfrm_body" style="height:60vh; overflow:hidden;">
                    <h2 class="header2 text-center text-uppercase">Director Login</h2>
                    ...
                    <br>
          			<form  method="post" action="<?php echo base_url('welcome/check_director_login')?>">
                    ...
                    <div class="col-md-12 text-center"><br>
                       ...
                       <a href="<?php echo base_url('director_register')?>">New To Casting Role?</a><br/>
					</div> 
				  </form>
				</div>
				</div>
