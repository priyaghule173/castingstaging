...
<html>
<head>
<!-- <script src="<?php echo base_url()?>assets/editor/live/console_runner-079c09a0e3b9ff743e39ee2d5637b9216b3545af0de366d4b9aad9dc87e26bfd.js">
</script>
<script src="<?php echo base_url()?>assets/editor/live/events_runner-73716630c22bbc8cff4bd0f07b135f00a0bdc5d14629260c3ec49e5606f98fdd.js">
</script>
<script src="<?php echo base_url()?>assets/editor/live/css_live_reload_init-2c0dc5167d60a5af3ee189d570b1835129687ea2a61bee3513dee3a50c115a77.js"></script>
<meta charset='UTF-8'><meta name="robots" content="noindex">
<link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url()?>assets/favicon/favicon-8ea04875e70c4b0bb41da869e81236e54394d63638a1ef12fa558a4a835f1164.ico" />
<link rel="mask-icon" type="" href="<?php echo base_url()?>assets/favicon/logo-pin-f2d2b6d2c61838f7e76325261b7195c27224080bc099486ddd6dccb469b8e8e6.svg" color="#111" />
<link rel="canonical" href="<?php echo base_url()?>https://codepen.io/dpinnick/pen/LjdLmo?limit=all&page=21&q=service" />

<link rel='stylesheet prefetch' href="<?php echo base_url()?>https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"> -->
...
<!--Director Login -->
  ...
  <?php 
                        if($this->session->flashdata('message')){ ?>
                          ...
                          <div class="col-lg-12">
                              <div class="alert alert-success alert-dismissible" style="background-color: green;color: #fff;">
            ...
            <form class="login-form" action="<?php echo base_url('welcome/check_director_login'); ?>" method="post">

            <input type="text" class="input" id="email_id" name="d_email" autocomplete="off" placeholder="Email or Username">
            <input type="password" class="input" id="password" name="d_password" autocomplete="off" placeholder="Password">
                            ...
                            <p><i class="fa fa-arrow-left" aria-hidden="true"></i><a class="forgot" href="#">Forgot your password?</a></p>
                                ...
                                <!--    <input type="submit" class="button" value="Login"> -->
                                     <button type="submit" class="btn btn-default rounded-btn" >Login</button>
                          <!--  <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                            <button type="submit" class="button" value="Sign Up" style="margin:0 auto;
                                            padding: 0.7em 5.8em;    margin-top: 25px;">Sign Up</button> 
                                        </div>
                                    </div> -->
...
<!-- TABS CONTENT SIGNUP -->
                    		...
                    		<div id="signup-tab-content">
                                  <input type="radio" id="artist1" name="logintype" checked="checked"  onclick="showArtist();">Artist
                               <input type="radio" id="director1" name="logintype"  onclick="showdirector();">Director
                        ...
                        <input type="text" class="input" id="mobile" autocomplete="off" placeholder="mobile">
                    	<input type="email" class="input" id="email" autocomplete="off" placeholder="Email">
                        <input type="password" class="input" id="pass2" autocomplete="off" placeholder="Password">
        ...
        <div class="director_form" >
                    ...
                    <form class="signup-form" action="<?php echo base_url('welcome/director_reg/'); ?>" method="post" enctype="multipart/form-data">
                    <!--   <input type="radio" id="artist2" name="logintype" onclick="showArtist();">Artist

                         <input type="radio" id="director2" name="logintype"  onclick="showdirector();">Director -->
            <input type="taxt" class="input" name="companyName" autocomplete="off" placeholder="Company / Official Name">
                        <input type="text" class="input" name="contact_no" id="contact_no" autocomplete="off" placeholder="Contact Number">
                        <input type="email" class="input"  name="dir_email" id="dir_email" autocomplete="off" placeholder="Official Email ID">

                        <input type="text" class="input" name="city" id="city" autocomplete="off" placeholder="City Name">
                        <input type="text" class="input" name="pin_code" id="pin_code" autocomplete="off" placeholder="Pin Code">
                        <input type="text" class="input" name="off_add" id="off_add" autocomplete="off" placeholder="Official Address">
 
                        <input type="password" class="input" name="pass3" id="pass3" autocomplete="off" placeholder="Password">
                        <input type="password" class="input"name="pass4"  id="pass4" autocomplete="off" placeholder="Confirm Password">
                       <input type="file" name="profile_pic" accept="image/*">
                       <input type="file" name="script_name" accept="image/*">
                       <!--
                ...
                -->
                         ...
                         <div class="row">
                                 ...
                                 <!--   <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
                                            <input type="submit" class="button" value="Sign Up" style="margin:0 auto;
                                            padding: .2em 5.8em;">
                                        </div>
                                    </div>
                                -->
