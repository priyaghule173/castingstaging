...
">
    ...
    "></i>
          ...
          <img src="<?php echo base_url()?>assets/images/profile_pic/<?php echo $value['profile_pic']; ?>" class="picture-src" id="blah" title="" alt="" style="width: 70%;height: 197px;margin: 21 auto;border-radius: 10%;"/>

                                                    <!-- <img id="blah" /> -->
                                                  <?php }else { ?>
                                                      
          <img src="<?php echo base_url()?>assets/images/profile_pic/userprofile.jpg" class="picture-src" id="wizardPicturePreview" title="" alt="" style="width: 70%;height: 197px;margin: 21 auto;border-radius: 10%;"/>
                                                  <?php } ?>
                   ...
                   <?php } else{ ?> 
                     ...
                     <?php } ?>
                                              ...
                                              <span class="input-group-btn ">
                                               <span class="btn btn-default btn-file addscript" style="height: 40px;width: 85px;background-color: #ff007c;padding-left: 15px;cursor: initial;">
                                                Browse<input type="file" readonly name="script_name"  id="script_name" accept=".pdf,.doc" class="form-control" style="z-index: 2">
                                               </span>
                                               <?php if($value['script_file']){  ?>
                          <label class="txtgreen" id="script-name"> <?php echo $value['script_file']; ?> </label>
                   <?php } else{ ?> 
    ...
    ">
                                ...
                                <a href="javascript:void(0);" class="addWorkBtnDemo1" onclick="Workdemo(<?php echo htmlspecialchars(json_encode($resultWork1)); ?>)" title="Add field"> <i class="fa fa-plus" aria-hidden="true"></i>&emsp;<label style="font-size: 20px; display: contents;color:green;cursor: pointer;">Add More Work Experience</label></a>
                            </div>
                          <?php }
                           else
                          { ?>
    ...
    ">
                                ...
                                onclick="Workdemo(<?php echo htmlspecialchars(json_encode($resultWork1)); ?>)" title="Add field"> <i class="fa fa-plus" aria-hidden="true"></i>&emsp;<label style="font-size: 20px; display: contents;color:green;cursor: pointer;">Add work Experience</label></a>
                            </div>
                          <?php }?>
                            <form id="prject1">
    ...
    "></i>
      ...
      <div class="col-md-6">
       ...
       <div class="form-group row required">
          ...
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext project_type<?php echo $countresu;?> " id="project_type<?php echo $key['work_id']?>" value="<?php echo $key['project_type'];?>" name="project_type" >
          </div>
        </div>
        <div class="form-group row required">
          <label for="staticEmail" class="col-md-5 col-form-label">Production Name</label>
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext production_name<?php echo $countresu;?> " value="<?php echo $key['production_name'];?>"  id="production_name<?php echo $key['work_id']?>" name="production_name" >
          </div>
        </div>
         <div class="form-group row">
          <label for="staticEmail" class="col-md-5 col-form-label">Link If Any</label>
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext link<?php echo $countresu;?>" name="link" id="link<?php echo $key['work_id']?>" style="
      ...
      <div class="form-group row required">
          ...
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext project_title<?php echo $countresu;?>" name="project_title" value="<?php echo $key['project_title'];?>"  id="project_title<?php echo $key['work_id']?>"  class="form-control" >
          </div>
        </div>
      ...
      <div class="form-group row required">
          ...
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext year<?php echo $countresu;?>" name="year" value="<?php echo $key['year'];?>"  id="year<?php echo $key['work_id']?>" class="form-control" value="" >
          </div>
        </div>
        <div class="form-group row">
          <label for="staticEmail" class="col-md-5 col-form-label">Additional Details</label>
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext additional_info<?php echo $countresu;?>" readonly name="additional_info" id="additional_info<?php echo $key['work_id']?>" value="<?php echo $key['additional_info'];?>" class="form-control" >
          </div>
        </div>
                    </div>
  ...
  var socialdiv12 = document.getElementById('social_parent_div');
   ...
   for(var i=0;i<resultData.length;i++)
    ...
    ">
                                ...
                                <a href="javascript:void(0);" class="addVideoBtnDemo" onclick="demo(<?php echo htmlspecialchars(json_encode($resultAward1)); ?>)" title="Add field"> <i class="fa fa-plus" aria-hidden="true"></i>&emsp;<label style="font-size: 20px; display: contents;color:green;cursor: pointer;">Add More Awards/Recognitions</label></a>
    ...
    ">
                                ...
                                <a href="javascript:void(0);" class="addVideoBtnDemo" onclick="demo(<?php echo htmlspecialchars(json_encode($resultAward1)); ?>)" title="Add field"> <i class="fa fa-plus" aria-hidden="true"></i>&emsp;<label style="font-size: 20px; display: contents;color:green;cursor: pointer;">Add Awards/Recognitions</label></a>
    ...
    cursor: pointer;
       ...
       <div class="form-group row required">
          ...
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext award_title<?php echo $awardcountresu;?>" readonly id="award_title<?php echo $val['award_id']?>" value="<?php echo $val['award_title'];?>"  name="award_title" class="form-control" >
          </div>
      </div>
          ...
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext award_year<?php echo $awardcountresu;?>" readonly name="award_year" id="award_year<?php echo $val['award_id']?>" class="form-control" value="<?php echo $val['award_year'];?>"  class="form-control" >
          </div> 
      </div>     
      ...
      <div class="form-group row required">
          ...
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext award_for<?php echo $awardcountresu;?>" readonly name="award_for" id="award_for<?php echo $val['award_id']?>" value="<?php echo $val['award_for'];?>"  class="form-control" value="" >
          </div>
      </div>
      <div class="form-group row">
          <label for="staticEmail" class="col-md-5 col-form-label">Additional Details </label>
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext add_details<?php echo $awardcountresu;?>" readonly name="add_details" id="add_details<?php echo $val['award_id']?>" value="<?php echo $val['add_details'];?>">
          </div>
      </div>
...
">
                       ...
                       <div class="col-lg-6 hideIconsocial" style="margin-left: 490px;margin-top: -3px;">
                        
                        <i class="fa fa-edit" data-toggle="modal" onclick="newSocial()" style="float: right;
          display: initial;
          font-size: 21px;
          padding-top: 19px;
          margin-left: 282px;
...
">
          ...
          padding: 5px;" value="<?php echo $value['imdb_url'];?>" id="imdb"  name="imdb"   placeholder="IMDB"/>
                                           ...
                                           <div class="col-lg-12 text-right hideSaveSocial" style="margin-left: 47px;
    margin-bottom: 20px;">
    ...
    ">
                                ...
                                <a href="javascript:void(0);" class="addAssocBtnDemo" onclick="Assocdemo(<?php echo htmlspecialchars(json_encode($resultaddassoc)); ?>)" title="Add field"> <i class="fa fa-plus" aria-hidden="true"></i>&emsp;<label style="font-size: 20px; display: contents;color:green;cursor: pointer;">Add More Associations</label></a>
                            </div>
                             <?php }
                           else
                          { ?>
    ...
    ">
                                ...
                                <a href="javascript:void(0);" class="addAssocBtnDemo" onclick="Assocdemo(<?php echo htmlspecialchars(json_encode($resultaddassoc)); ?>)" title="Add field"> <i class="fa fa-plus" aria-hidden="true"></i>&emsp;<label style="font-size: 20px; display: contents;color:green;cursor: pointer;">Add Associations</label></a>
                            </div>
                             <?php }?>
    ...
    cursor: pointer;
      ...
      <div class="form-group row required">
          ...
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext association_name<?php echo $queryresultassoc;?> " class="form-control" readonly id="association_name<?php echo $valu['assoc_id']?>" name="association_name" value="<?php echo $valu['association_name'];?>" >
          </div>
      </div>
      ...
      <div class="form-group row required">
          ...
          <div class="col-md-7">
            <input type="text" readonly class="form-control-plaintext associaton_id<?php echo $queryresultassoc;?>" name="association_id" id="associaton_id<?php echo $valu['assoc_id']?>" value="<?php echo $valu['associaton_id'];?>" class="form-control" >
          </div>
      </div>
